...
# # Streamlit App
# st.set_page_config(page_title="DefenSys", layout="wide", page_icon=":guardsman:", initial_sidebar_state="expanded")
# st.title("DefenSys")
...
# CSS for camouflage background
camouflage_css = """
<style>
body {
    background-image: 'army.jpg'; /* Camouflage background image */
    background-size: cover;
    background-attachment: fixed;
    color: white;
}
.sidebar .sidebar-content {
    background-color: #3b4d3b; /* Dark green for sidebar */
    color: white;
}
button, input {
    background-color: #2a2a2a; /* Button and input styling */
    color: white;
    border: 1px solid #555;
}
</style>
"""
st.markdown(camouflage_css, unsafe_allow_html=True)
...
def login():
    ...
    if st.button("Login"):
        if username == "admin" and password == "admin":
            ...
            time.sleep(1)  # Add a slight delay for a smoother transition
        else:
